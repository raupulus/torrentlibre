...
/**
 * PuntuacionController implements the CRUD actions for PuntuacionTorrents model.
 */
class PuntuacionController extends Controller
{
    ...
    /**
     * Lists all PuntuacionTorrents models.
     * @return mixed
     */
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => PuntuacionTorrents::find(),
        ]);
    ...
    /**
     * Displays a single PuntuacionTorrents model.
     * @param integer $id
     * @return mixed
