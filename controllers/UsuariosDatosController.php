...
class UsuariosDatosController extends Controller
{
    ...
    /**
     * Lists all UsuariosDatos models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new UsuariosDatosSearch();
    ...
    /**
     * Displays a single UsuariosDatos model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new UsuariosDatos model.
    ...
    /**
     * Deletes an existing UsuariosDatos model.
